...
\title{Python Twitter情緒分析 報告擴展}
\subtitle{資料整理、情緒評分與視覺化流程}
...
\vspace*{1.35cm}
\centering
{\color{TextLight}\bfseries\fontsize{25}{31}\selectfont Python Twitter情緒分析\par}
\vspace{0.24cm}
{\color{TextLight}\bfseries\fontsize{23}{29}\selectfont 報告擴展\par}
\vspace{0.45cm}
\begin{tikzpicture}
  \shade[left color=GradientStart, right color=GradientEnd]
    (0,0) rectangle (8.2,0.10);
\end{tikzpicture}\par
\vspace{0.55cm}
{\color{TextLight!82}\Large 資料整理、情緒評分\par}
\vspace{0.12cm}
{\color{TextLight!82}\Large 與視覺化流程\par}
\vspace{0.95cm}
{\color{GradientEnd}\Large 製作人 B12204033 施卲\par}
\vspace{0.32cm}
{\color{TextLight!80}\large 期末專題簡報\par}
\vfill
\end{frame}
...
\begin{tikzpicture}[node distance=1.25cm, >=latex, rounded corners]
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm] (raw) {原始 CSV};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, right=of raw] (load) {資料載入};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, right=of load] (clean) {文字清理};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, right=of clean] (sent) {情緒判定};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, below=of clean] (agg) {時間聚合};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, left=of agg] (report) {CSV 報表};
  \node[draw=GradientEnd!55!white, fill=white!6!PanelMid, text=TextLight, minimum width=2.2cm, minimum height=0.95cm, right=of agg] (fig) {圖形輸出};
